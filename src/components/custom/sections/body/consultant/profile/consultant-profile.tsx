...
export default function ConsultantProfilePage() {
  ...
  const [consultant, setConsultant] = useState<ConsultantData>({
    ...
    recentActivities: [
      {
        type: "template",
        content: "Published 'Modern Business' template",
        date: "2023-05-20",
      },
      {
        type: "reply",
        content: "Replied to customer inquiry about pricing",
        date: "2023-05-18",
      },
      {
        type: "template",
        content: "Edited 'Sleek Portfolio' template",
        date: "2023-05-15",
      },
      {
        type: "reply",
        content: "Assisted customer with design customization",
        date: "2023-05-10",
      },
    ],
  });
                ...
                <div className="flex items-center">
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      onChange={(e) =>
                        setConsultant({ ...consultant, email: e.target.value })
                      }
                    />
                  ) : (
                ...
                <div className="flex items-center">
                  ...
                  {isEditing ? (
                    <Input
                      ...
                      onChange={(e) =>
                        setConsultant({ ...consultant, phone: e.target.value })
                      }
                    />
                  ) : (
