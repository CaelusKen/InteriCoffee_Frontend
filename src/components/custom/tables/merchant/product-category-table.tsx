...
const fetchCategory = async (
  ...
  return api.getPaginated<ProductCategory>(
    "product-categories",
    undefined,
    accessToken
  );
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem
                  onClick={() =>
                    router.push(
                      `/manager/product-categories/${productCategory.id}/update`
                    )
                  }
                >
                  Edit
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        <Button
          onClick={() => router.push("/merchant/product-categories/create")}
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              category from our servers. (we seriously mean it!!!)
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
