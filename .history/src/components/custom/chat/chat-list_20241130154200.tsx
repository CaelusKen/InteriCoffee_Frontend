...
const chatData = [
  { id: "1", name: 'Espresso Emporium', lastMessage: 'Your order is ready!', unread: 2, assignedTo: 'Alice' },
  { id: "2", name: 'Latte Lounge', lastMessage: 'Can you clarify your last question?', unread: 0, assignedTo: 'Bob' },
  { id: "3", name: 'Mocha Maven', lastMessage: 'We have a new blend you might like.', unread: 1, assignedTo: null },
]
...
export default function ChatList({ role, onSelectChat }: ChatListProps) {
      ...
      {chatData.map((chat) => (
        ...
        >
          ...
          <div className="flex-grow">
            ...
            {role === 'merchant' && (
              <p className="text-xs text-neutrals-500 dark:text-neutrals-400">
                {chat.assignedTo ? `Assigned to: ${chat.assignedTo}` : 'Unassigned'}
              </p>
            )}
          </div>
          {chat.unread > 0 && (
