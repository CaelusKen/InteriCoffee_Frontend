...
export default function Dashboard() {
  ...
  const account = () => {
    if (accountQuery.isLoading) return console.log('account is loading');
    
    if (accountQuery.error) return console.error('account query error,' + accountQuery.error)
    return mapBackendToFrontend<Account>(accountQuery.data?.data, 'account')
  }
