...
const fetchTemplates = async() : Promise<ApiResponse<PaginatedResponse<any>>> => {
  return api.getPaginated<any>('templates')
}
...
export default function Dashboard() {
  ...
  const templateQuery = useQuery({
    ...
    select: (data) => {
      ...
      return mapBackendListToFrontend<Template>(data.data.items, 'template').items;
  ...
  console.dir(templateQuery.data);
